...
|------|----------|-----------|
| 2026-06-21 | **Framework: Next.js (React, TypeScript)** | Robust SSR and file-based routing standard. |
| 2026-06-21 | **Styling: Tailwind CSS** | Rapid UI development matching mobile's aesthetic easily. |
| 2026-06-21 | **Auth: existing JWT in httpOnly cookie** | Reuses backend exactly; httpOnly prevents XSS vs localStorage. |
| 2026-06-21 | **No new backend endpoints (MVP)** | Ensures identical capabilities across platforms and maintains API scope. |
