...
void setupFlutterTtsMock() {
  ...
  const MethodChannel justAudioChannel =
      MethodChannel('com.ryanheise.just_audio.methods');
  const MethodChannel audioServiceChannel =
      MethodChannel('com.ryanheise.audio_service');
  ...
  TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
      .setMockMethodCallHandler(audioServiceChannel,
          (MethodCall methodCall) async {
    return null;
  });
}
